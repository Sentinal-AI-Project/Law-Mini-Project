            ...
            <>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
                <div>
                  ...
                  <h1 style={{ fontSize: '1.25rem', color: '#1e293b', marginBottom: '0.75rem', fontWeight: 500, textAlign: 'justify' }}>{activeFinding.description || 'Finding'}</h1>
                  <p style={{ color: '#475569', fontSize: '0.95rem', textAlign: 'justify', lineHeight: 1.6 }}>{activeFinding.explanation || 'Detailed analysis of human-readable explanation of risk.'}</p>
                </div>
              ...
              {(activeFinding.evidence_snippet || activeFinding.clause_id?.clause_text) && (
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  <div style={{ background: '#fef9c3', padding: '1.25rem', borderRadius: '8px', border: '1px solid #fef08a', color: '#422006', lineHeight: 1.6, textAlign: 'justify', fontSize: '0.9rem' }}>
                    "{activeFinding.evidence_snippet || activeFinding.clause_id?.clause_text}"
                  </div>
